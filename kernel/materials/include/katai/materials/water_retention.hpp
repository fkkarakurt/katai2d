...
// permeability — unsaturated flow. The "van Genuchten" retention model; parameters
// g_a [1/length], g_n, g_l.
...
// Moisture capacity (for the transient storage matrix S):
...
// (1e-4 by default; keeps the system from turning singular in the dry zone).
